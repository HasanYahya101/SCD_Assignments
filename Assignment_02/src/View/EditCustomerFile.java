...
public class EditCustomerFile extends JFrame {
    ...
    private void init() {
        ...
        for (int i = 0; i < size; i++) {
            data[i][0] = customer.customer_data.get(i).Unique_ID;
            data[i][1] = customer.customer_data.get(i).CNIC;
            data[i][2] = customer.customer_data.get(i).Name;
            data[i][3] = customer.customer_data.get(i).Address;
            data[i][4] = customer.customer_data.get(i).Phone_No;
            data[i][5] = customer.customer_data.get(i).cust_type;
            data[i][6] = customer.customer_data.get(i).meter_type;
            data[i][7] = customer.customer_data.get(i).reg_units_comsumed;
            data[i][8] = customer.customer_data.get(i).peak_units_comsumed;
            data[i][9] = "Update";
            data[i][10] = "Delete";
        }
        ...
        public Object getCellEditorValue() {
            if (isPushed) {
                if (label.equals("Update")) {
                    ...
                    Customer_Data temp_data = new Customer_Data(UniqueID, CNIC, Name, Address, Phone, cust_type,
                            meter_type,
