...
public class EditBillingFile extends JFrame {
    ...
    private void init() {
        ...
        DefaultTableModel model = new DefaultTableModel(
            ...
            boolean[] canEdit = new boolean[] { false, false, false, true, true, false, true, true, true, true, true,
                    false,
                    false, true, true };
            String latest_date = new Billing().get_latest_date();
    ...
    class ButtonRenderer extends JButton implements TableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value,
            ...
            if (EntryDate.equals(new Billing().get_latest_date()) == false) {
                setEnabled(false);
            } else {
                setEnabled(true);
            }
    ...
    class ButtonEditor extends DefaultCellEditor {
        ...
        public boolean is_valid_date_format(String dt) {
        ...
        public boolean first_is_after_second(String first, String second) {
            ...
            if (isPushed) {
                if (label.equals("Update")) {
                    ...
                    if (Payment_Date.equals("") == false) {
                        ...
                        if (first_is_after_second(Payment_Date, Entry_Date) == false) {
                    ...
                    Billing_Data billing_data = new Billing_Data(Customer_ID, Billing_Month, Billing_Year,
                            Current_Reading_Reg, Current_Reading_Peak, Entry_Date, Electricity_Cost, Sales_Tax,
                    ...
                    Billing billing = new Billing();
                    boolean success = billing.delete_bill(Customer_ID, Billing_Month, Billing_Year, Entry_Date);
                    billing.save_data();
                    billing.load_data();
