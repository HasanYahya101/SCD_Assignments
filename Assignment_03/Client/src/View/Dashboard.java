...
public class Dashboard extends JFrame {
    ...
    private Map<String, Class<? extends JPanel>> panelMap;
    ...
    public Dashboard() {
        ...
        panelMap.put("NewMeter", NewMeter.class);
        panelMap.put("UpdateCustomerInfo", UpdateCustomerData.class);
        panelMap.put("CreateThisMonthBill", CreateMonthsBill.class);
        panelMap.put("PayBills", PayBill.class);
        panelMap.put("UpdateTaxInfo", UpdateTaxInfo.class);
        panelMap.put("ViewBill", ViewBill.class);
        panelMap.put("ViewBillReport", ViewBillReport.class);
        panelMap.put("SeeExpiredCNIC", SeeExpiredCNIC.class);
        panelMap.put("EditFiles", EditFiles.class);
        ...
        // new_meter_btt.addActionListener(e -> cardLayout.show(rightPanel,
        // "NewMeter"));
        // update_cust_info_btt.addActionListener(e -> cardLayout.show(rightPanel,
        // "UpdateCustomerInfo"));
        // create_this_month_bill_btt.addActionListener(e -> cardLayout.show(rightPanel,
        // "CreateThisMonthBill"));
        // pay_bills_btt.addActionListener(e -> cardLayout.show(rightPanel,
        // "PayBills"));
        // update_tax_info_btt.addActionListener(e -> cardLayout.show(rightPanel,
        // "UpdateTaxInfo"));
        // view_bill_btt.addActionListener(e -> cardLayout.show(rightPanel,
        // "ViewBill"));
        // view_bill_report_btt.addActionListener(e -> cardLayout.show(rightPanel,
        // "ViewBillReport"));
        // see_expired_cnic_btt.addActionListener(e -> cardLayout.show(rightPanel,
        // "SeeExpiredCNIC"));
        // edit_files_btt.addActionListener(e -> cardLayout.show(rightPanel,
        // "EditFiles"));
        new_meter_btt.addActionListener(e -> showPanel("NewMeter"));
        update_cust_info_btt.addActionListener(e -> showPanel("UpdateCustomerInfo"));
        create_this_month_bill_btt.addActionListener(e -> showPanel("CreateThisMonthBill"));
        pay_bills_btt.addActionListener(e -> showPanel("PayBills"));
        update_tax_info_btt.addActionListener(e -> showPanel("UpdateTaxInfo"));
        view_bill_btt.addActionListener(e -> showPanel("ViewBill"));
        view_bill_report_btt.addActionListener(e -> showPanel("ViewBillReport"));
        see_expired_cnic_btt.addActionListener(e -> showPanel("SeeExpiredCNIC"));
        edit_files_btt.addActionListener(e -> showPanel("EditFiles"));
    ...
    private void showPanel(String panelName) {
        // Remove the existing panel with the same name, if any
        if (cardLayout != null) {
        ...
        try {
            // Dynamically create a new instance of the panel
            JPanel panel = panelMap.get(panelName).getDeclaredConstructor().newInstance();
            rightPanel.add(panel, panelName);
            cardLayout.show(rightPanel, panelName);
        } catch (Exception e) {
            e.printStackTrace();
            JOptionPane.showMessageDialog(this, "Error loading panel: " + panelName);
        }
    }
