...
public class ViewBillReport extends JPanel {
    ...
    private void init() {
        ...
        paid = (int) cl.sendRequest("billing.get_reports_paid");
        unpaid = (int) cl.sendRequest("billing.get_reports_unpaid");
        ...
        calculateButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                int paid = (int) cl.sendRequest("billing.get_reports_paid");
                int unpaid = (int) cl.sendRequest("billing.get_reports_unpaid");
                unpaidBillsLabel.setText("There are a total of " + unpaid + " unpaid bills");
                paidBillsLabel.setText("There are a total of " + paid + " paid bills");
                System.out.println("Recalculated: " + paid + " " + unpaid);
            }
        });
        add(calculateButton);
    }
